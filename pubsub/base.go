...
type SubscriptionRoutine = func(topic string, doneChannel <-chan bool, messages chan<- ForwardedMessage, subscriptionDone chan<- bool, ctx context.Context)
...
func baseSubscribe(ctx context.Context, topic string, lgh ListenGroupHandler, listenerId string, subscriptionRoutine SubscriptionRoutine) (chan ForwardedMessage, error) {
